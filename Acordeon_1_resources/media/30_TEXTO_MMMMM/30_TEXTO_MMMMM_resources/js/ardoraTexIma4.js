...
$("#goLeftBut").click(function() {window.open("30_TEXTO_MMMMM3.htm","_self");});
$("#goLeftBut").keydown(function(e) {if (e.which != 9) {window.open("30_TEXTO_MMMMM3.htm","_self");}});
$("#goRightBut").click(function() {window.open("30_TEXTO_MMMMM5.htm","_self");});
$("#goRightBut").keydown(function(e) {if (e.which != 9) {window.open("30_TEXTO_MMMMM5.htm","_self");}});
...
imaUp("30_TEXTO_MMMMM_resources/media/menuFiles/4_15_alpa.jpg");
});
...
if (e.which!=9){imaUp('30_TEXTO_MMMMM_resources/media/imaLarge/ti_28__ALPACA.jpg');}});
});
