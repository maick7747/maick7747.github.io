...
$("#goLeftBut").click(function() {window.open("30_TEXTO_MMMMM6.htm","_self");});
$("#goLeftBut").keydown(function(e) {if (e.which != 9) {window.open("30_TEXTO_MMMMM6.htm","_self");}});
$("#goRightBut").click(function() {window.open("30_TEXTO_MMMMM8.htm","_self");});
$("#goRightBut").keydown(function(e) {if (e.which != 9) {window.open("30_TEXTO_MMMMM8.htm","_self");}});
...
imaUp("30_TEXTO_MMMMM_resources/media/menuFiles/7_128__CUY.jpg");
});
...
if (e.which!=9){imaUp('30_TEXTO_MMMMM_resources/media/imaLarge/ti_28__CUY.jpg');}});
});
