...
$("#ardoraMain").append("<div id='"+imaN+"' class='photoMG'><img src='28_GALERIA_M_resources/media/imaMG/" + fileIma[num-1] + "'/></div>");
...
$("#upN").blur(function(e){$(this).css("color","#4A60B5")});
}
...
$("#" + nextN).blur(function(e){$(this).css("color","#4A60B5")});
...
$("#" + prevN).blur(function(e){$(this).css("color","#4A60B5")});
$("#"+titN).click(function() {
$("#"+imaN).animate({
left: ($("#item" + num.toString()).position().left+$("#item" + num.toString()).width()/2).toString() + "px",
top: ($("#item" + num.toString()).position().top+$("#item" + num.toString()).height()/2).toString()+"px",
...
$("#" + titN).blur(function(e){$(this).css("color","#4A60B5")});
...
$("#"+imaN).append("<img src='28_GALERIA_M_resources/media/imaMG/" + fileIma[num-1] + "'/>");
}else{
$("#"+imaN+ " img").remove();
if (conType[num-1]=="0"){
...
$("#txtN").blur(function(e){$(this).css("color","#4A60B5")});
}
function fullS(num){
...
$("#" + fullN).blur(function(e){$(this).css("color","#4A60B5")});
}
function showImaFull(num){
$("#ardoraMain").append("<div id='imaFull'><img alt='"+altIma[num - 1]+"' src='28_GALERIA_M_resources/media/imaFull/f_" + fileIma[num-1].substring(2) + "'/></div>");
cssColors();
...
$("#titF").blur(function(e){$(this).css("color","#4A60B5")});
$("#nextF").focus(function(e){$(this).css("color","#000000")});
$("#nextF").blur(function(e){$(this).css("color","#4A60B5")});
$("#prevF").focus(function(e){$(this).css("color","#000000")});
$("#prevF").blur(function(e){$(this).css("color","#4A60B5")});
$("#txtF").focus(function(e){$(this).css("color","#000000")});
$("#txtF").blur(function(e){$(this).css("color","#4A60B5")});
...
$("#imaFull").append("<img alt='"+altIma[num-1]+"' src='28_GALERIA_M_resources/media/imaFull/f_"+fileIma[num-1].substring(2)+"'/>");
...
if ($.trim(fileMP3[num-1])){sourceLine=sourceLine+"<source src='28_GALERIA_M_resources/media/"+fileMP3[num-1]+"' type='audio/mp3' />";}
if ($.trim(fileOgg[num-1])) {sourceLine=sourceLine+"<source src='28_GALERIA_M_resources/media/"+fileOgg[num-1]+"' type='audio/ogg' />";}
...
sourceLine=sourceLine+"<source src='28_GALERIA_M_resources/media/"+fileMP3[num-1]+"' type='audio/mp3' />";}
if ($.trim(fileOgg[num-1])) {
sourceLine=sourceLine+"<source src='28_GALERIA_M_resources/media/"+fileOgg[num-1]+"' type='audio/ogg'/>";}
...
$("#musN").blur(function(e){$(this).css("color","#4A60B5")});
}
