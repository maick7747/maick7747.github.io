...
$("#help_div").html("<img tabindex='0' id='playSound' class='imaLeft' src='Construye_palabras_resources/media/sound.png' alt='Play' align='left'>"+ "<p>" +ConstruPalWords(cp_que[jobindex[indexGame-1]])+ "</p>");
