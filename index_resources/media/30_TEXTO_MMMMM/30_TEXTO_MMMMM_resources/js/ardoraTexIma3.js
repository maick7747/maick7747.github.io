...
$("#goLeftBut").click(function() {window.open("30_TEXTO_MMMMM2.htm","_self");});
$("#goLeftBut").keydown(function(e) {if (e.which != 9) {window.open("30_TEXTO_MMMMM2.htm","_self");}});
$("#goRightBut").click(function() {window.open("30_TEXTO_MMMMM4.htm","_self");});
$("#goRightBut").keydown(function(e) {if (e.which != 9) {window.open("30_TEXTO_MMMMM4.htm","_self");}});
...
imaUp("30_TEXTO_MMMMM_resources/media/menuFiles/3_15__cerdo.jpg");
});
...
if (e.which!=9){imaUp('30_TEXTO_MMMMM_resources/media/imaLarge/ti_28__CERDO.jpg');}});
});
